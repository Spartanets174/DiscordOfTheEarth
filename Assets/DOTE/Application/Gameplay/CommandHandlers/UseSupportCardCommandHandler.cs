...
{
    public class UseSupportCardCommandHandler : ACommandHandler<UseSupportCardCommand>
    {
        private IPlayerRepository playerRepository;
        private ISupportCardRepository supportCardRepository;
        private IGamePartyRepository gamePartyRepository;

        public UseSupportCardCommandHandler(IPlayerRepository playerRepository, ISupportCardRepository supportCardRepository, IGamePartyRepository gamePartyRepository)
        {
        ...
        public override void HandleHook(UseSupportCardCommand command)
        {
            ...
            {
                gameParty.CurrentState.UseSupportCard(player, supportCard);
            }
        }
    }
}
