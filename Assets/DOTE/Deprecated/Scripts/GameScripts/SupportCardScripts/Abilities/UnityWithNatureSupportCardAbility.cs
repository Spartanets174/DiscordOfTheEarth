...
public class UnityWithNatureSupportCardAbility : BaseSupportÑardAbility, ITurnCountable
{
    ...
    public void ReturnToNormal()
    {
        ...
        if (isDeath)
        {
            ...
            battleSystem.gameLogCurrentText.Value = $"İôôåêò äîïîëíèòåëüíîãî çäîğîâüÿ îò êàğòû \"Åäèíñòâî ñ ïğèğîäîé 2\" çàêàí÷èâàåòñÿ, {characterType} ïåğñîíàæ <color=#{ColorUtility.ToHtmlStringRGB(characterColor)}>{character.CharacterName}</color> ïîãèáàåò";
